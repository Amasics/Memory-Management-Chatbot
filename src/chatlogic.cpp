...
ChatLogic::ChatLogic()
{
    ...
    // ChatLogic has no ownership of chatbot
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            (*parentNode)->AddEdgeToChildNode(std::move(edge));  // change ownership
                        }
    ...
    // create a local chatbot instance on the stack, pass it into the rootnode using move semantics
